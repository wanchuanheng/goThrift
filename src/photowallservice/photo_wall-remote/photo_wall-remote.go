...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  RespHttpPackage doRequest(ReqHttpPackage req,  extInfo)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := photowallservice.NewPhotoWallClientFactory(trans, protocolFactory)
	...
	case "doRequest":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "DoRequest requires 2 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		argvalue0 := photowallservice.NewReqHttpPackage()
		...
		containerStruct1 := photowallservice.NewPhotoWallDoRequestArgs()
		err19 := containerStruct1.ReadField2(jsProt18)
		if err19 != nil {
			Usage()
			return
		}
		argvalue1 := containerStruct1.ExtInfo
		value1 := argvalue1
		fmt.Print(client.DoRequest(value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
